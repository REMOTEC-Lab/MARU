    ...
    "btn": {
        "DATA": {
            Request: function (e, PageBlock) {
                //console.log('response : TEST' + oPageInfo.page);
                window['Maru_' + oPageInfo.page].btn_Data("TEST WEB")
                //window['Maru_' + oPageInfo.page].btn_Data();
//                try {
//                    requestPage.call(this, {
//                        url: 'html/dataList/dataList_one.html',
//                        target_id: 'dataList-body',
//                        id: 'dataList_one'
//                    });
